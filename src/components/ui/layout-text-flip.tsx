...
export const LayoutTextFlip = ({
  ...
  words: string[];
  duration?: number;
  /** Applied to the outer flex wrapper (alignment, gap). */
  className?: string;
  /** Typography and color for the static prefix text. */
  staticClassName?: string;
  /** Typography and framing for the flipping word box. */
  ...
  return (
    <div
      className={cn(
        "inline-flex flex-wrap items-baseline gap-2 text-left",
        className,
      )}
    >
      <motion.span
